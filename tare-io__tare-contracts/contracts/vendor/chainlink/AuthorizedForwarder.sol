...
// (contracts/src/v0.8/operatorforwarder/AuthorizedForwarder.sol).
// Diff from upstream: fixed `pragma solidity 0.8.19` relaxed to `^0.8.19` so the
// contract can compile in this repo's 0.8.33 compilation unit; imports repointed
// to the vendored copies alongside this file. No logic changes.
pragma solidity ^0.8.19;

import {ConfirmedOwnerWithProposal} from "./ConfirmedOwnerWithProposal.sol";
// `Address` is the vendored OZ v4.8.3 copy (this repo's OZ 5.x removed `Address.isContract`).
